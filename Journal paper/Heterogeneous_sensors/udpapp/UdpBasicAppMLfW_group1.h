...
#ifndef __INET_UDPBASICAPPMLfW_GROUP1_H
#define __INET_UDPBASICAPPMLfW_GROUP1_H
 ...
 */
class INET_API UdpBasicAppMLfW_group1 : public ApplicationBase, public UdpSocket::ICallback
{
  protected:
