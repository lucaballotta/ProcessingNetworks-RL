...
#ifndef __INET_UDPBASICAPPMLfW_GROUP2_H
#define __INET_UDPBASICAPPMLfW_GROUP2_H
 ...
 */
class INET_API UdpBasicAppMLfW_group2 : public ApplicationBase, public UdpSocket::ICallback
{
  protected:
